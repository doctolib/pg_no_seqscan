...
-- Blocks query execution as both parts are seq scan
...
-- Blocks query execution as one part of the append is an index scan.
...
-- Allows query execution as both part are index scan
